...
@section('content')
    ...
    <img src="assets/img/banner-0.png" width="100%" height="100%" alt="banner">
        </br></br></br></br>
    ...
    <!-- <img src="assets/img/banner6.jpg" alt="Hero Image"> -->
        <div class="container">
            <div class="row d-flex align-items-center">
                <div class="col-xl-5">
                    <h1>lebih praktis <br> dengan <span>Smart Village</span></h1>
                    <p>Gunakan layanan dari aplikasi Smart Village untuk mengajukan surat - menyurat atau melakukan pengaduan
    ...
    <section class="feature">
        <div class="container">
            <div class="row mb-5 text-center">
                <div class="col">
                    <h2>Fitur Smart Village</h2>
                    <p>Dengan fitur dari Smart Village, masyarakat dapat lebih menghemat waktu dalam mengurus berkas</p>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
        ...
        <div class="container">
            <div class="row text-center mt-3">
                <div class="col text-light">
                    <p>Copyright &copy; 2024 &mdash; Smart Village-Canakya Bima Ananda Putra | All right reserved.</p>
                </div>
            </div>
        </div>
    </footer>
