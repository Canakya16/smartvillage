        ...
        <div class="container">
            <div class="row d-flex align-items-center">
                <div class="col-xl-12 text-center">
                    ...
                    <p>Temukan informasi mengenai Profil Desa Mlese.</p>
                </div>
            </div>
        </div>
    </section>
                            ...
                            <div class="accordion" id="accordionExample">
                                <div class="card">
                                    ...
                                    <div id="collapseOne" class="collapse" aria-labelledby="headingOne"
                                        ...
                                        <div class="card-body">
                                            <strong>Nama Instansi:</strong> <br> Kantor Desa Mlese <br><br>
                                            <strong>Alamat:</strong> <br> Jl. Klaten - Solo No.5, Jayan, Jombor, Kec. Ceper, Kabupaten Klaten, Jawa Tengah 57465
                                        </div>
                                    </div>
                                </div>
                                <div class="card">
                                    ...
                                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                                        data-parent="#accordionExample">
                                        <div class="card-body">
                                            <strong>VISI & MISI:</strong> <br> Agar pelaksanaan kegiatan penyelenggaraan Pemerintahan Desa dapat terlaksana dengan baik dan terarah perlu dicapai dengan rencana Strategis Desa, 
                                            ...
                                            <ul>
                                                <li>
                                                    Meningkatkan kinerja Pemerintah Desa Mlese 
                                                ...
                                                <li>
                                                    Meningkatkan potensi kelompok-kelompok berbagai bidang yang ada di Desa Mlese.
                                                </li>
                                                <li>
                                                    Meningkatkan koordinasi dan kerjasama dengan instansi atau Pemerintah Daerah.
                                                </li>
                                                <li>
                                                    Mengembangkan jaringan kerjasama dengan pihak-pihak lain untuk mendukung proses pembangunan di Desa Mlese.
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div id="collapseThree" class="collapse" aria-labelledby="headingThree"
                                        data-parent="#accordionExample">
                                        <div class="card-body">
                                        <img src="assets/img/petadesa.png" width="1000" height="500" class="d-inline-block align-top" alt="STRUKTUR">
                                        </div>
                                    </div>
                                </div>
                            </div>
